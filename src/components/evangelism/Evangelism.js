...
const Evangelism = () => {
    ...
    return (
        <div className="containerWhite">
            ...
            <img className="sectionMainImage" src="https://foundationsincreations.s3.amazonaws.com/evangelismMainImage.jpg" alt="Equipping / Education Tracks" title="Creation Science &amp; Bible-Based Courses / Seminars" />
            <h5 className="sectionMainImageCaption">ORIGINAL / SUNDAY MORNING SERMONS:</h5>
            <ul className="speechList">
                <li className="imgContainer">
                    <img className="img225" src="https://foundationsincreations.s3.amazonaws.com/sheepFromGoats.png" alt="Separating the Sheep from the Goats" title="Separating the Sheep from the Goats"/>
                    <p className="imgText">
