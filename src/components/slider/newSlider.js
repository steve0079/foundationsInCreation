        ...
        <div id='CustomerSlider' className="mainSlider">
            <Slider {...settings}>
                <div className="slide_1">
                    ...
                    <p className="slide_text">Please take a look around and let us know how we can assist you on your journey of discovery!</p>
                </div>
                <div className="slide_3">
                    <img src="https://foundationsincreations.s3.amazonaws.com/wordLovers_v3.jpg" alt="Gay Zambrano singing praise and worship" title="Gay Zambrano singing praise and worship" />
